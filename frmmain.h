...
private:
    ...
    QPixmap statsPx;
    QPixmap towerMenuClosePx;
    QPixmap towerMenuOpenPx;
    QPixmap waveBreakPx;
    //Playmenu
    QPixmap levelsPx;
    QPixmap ownMapsPx;
    ...
    const uint minusTowerCost = 50, herzTowerCost = 75, repostTowerCost = 150, benisTowerCost = 200,
        banTowerCost = 2000, sniperTowerCost = 350, flakTowerCost = 100, laserTowerCost = 300,
   ...
   -1 - Suspended
    ...
    int towerPxSize = 512;
    QRectF target;
    QRect playingModeRect = QRect(1604, 400, 168, 168);
    ...
    QRect towerMenuCloseRect = QRect(550,100,100,100);
    QRect towerMenuOpenRect = QRect(0,465,150,150);
    ...
    QRect mWaypointRect = QRect(1375,850,150,150);
    ...
    int createPath();
    int createMazePath(bool tmp = false);
    void zoom(double amount);
    void createPathBoundaries();
    void loginAccount();
    void createAccount();
    void saveAccount();
    void accountCreationError(int id = 0);
    void changeSize(QPainter &painter, int pixelSize, bool bold = false);
    void buyMinusTower(int tpos, bool intersects = false);
    void buyFavTower(int tpos, bool intersects = false);
    void buyRepostTower(int tpos, bool intersects = false);
    void buyBenisTower(int tpos, bool intersects = false);
    void buyBanTower(int tpos, bool intersects = false);
    void buySniperTower(int tpos, bool intersects = false);
    void buyFlakTower(int tpos, bool intersects = false);
    void buyLaserTower(int tpos, bool intersects = false);
    void buyPoisonTower(int tpos, bool intersects = false);
    void buyMinigunTower(int tpos, bool intersects = false);
...
private slots:
    ...
    void on_mapBuy(int subSelected, bool mode = 0);
    ...
    void on_zoomChanged();
    void on_status(QNetworkReply *reply);
